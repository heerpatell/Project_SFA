      ...
      >
        ...
        >
          <div>
            ...
            When you received a low tip,
            </div>
            <QuestionScale
              question="To what extent was the low tip likely the result of low effort level you chose?"
              name="low-effort"
              onChange={(value) => handleScaleChange("low-effort", value)}
            />
            <QuestionScale
              question="To what extent was the low tip likely the result of low willingness to tip from the Customer?"
              name="low-willingness"
              onChange={(value) => handleScaleChange("low-willingness", value)}
            />
          </div>

          <div>
            <div style={{ color: "#6AD4DD", paddingBottom:'0.2rem' }}>
            When you received a high tip,
            </div>
            <QuestionScale
              question="To what extent was the high tip likely the result of high effort level you chose?"
              name="high-effort"
              onChange={(value) => handleScaleChange("high-effort", value)}
            />
            <QuestionScale
              question="To what extent was the high tip likely the result of high willingness to tip from the Customer?"
              name="high-willingness"
              onChange={(value) => handleScaleChange("high-willingness", value)}
            />
          </div>

  ...
  useEffect(() => {
    axios
      ...
      .then(async (res) => {
        ...
        setLink(
          `https://project-sfa-frontend.onrender.com/link/${res.data.sessionObj.link}`
        );
        ...
        setActiveParticipant(
          res.data.sessionObj.no_of_active_participants
        );
      ...
      <div className="adminpage-outer">
        <div className="adminpage-content">
          ...
          <div className="secondrow-adminpage">
            <div
              style={{ fontSize: "1.6rem", display: "flex", color: "#adb5bd" }}
            >
              Number of Participants:{" "}
              <div style={{ color: "#6AD4DD" }}>&nbsp;&nbsp;{participants}</div>
            </div>
            <div
              style={{ fontSize: "1.6rem", display: "flex", color: "#adb5bd" }}
            >
              Number of Rounds:{" "}
              <div style={{ color: "#6AD4DD" }}>&nbsp;&nbsp;{rounds}</div>
            </div>
            <div
              style={{ fontSize: "1.6rem", display: "flex", color: "#adb5bd" }}
            >
              Entered Condition:{" "}
              <div style={{ color: "#6AD4DD" }}>&nbsp;&nbsp;{condition}</div>
            </div>
          </div>

          <div className="thirdrow-adminpage">
            <div style={{ fontSize: "2rem", display: "flex" }}>
              Total participants active at this moment:{" "}
              <div style={{ color: "#6AD4DD" }}>
                &nbsp;&nbsp;{activeParticipant}
              </div>
            </div>
          </div>
